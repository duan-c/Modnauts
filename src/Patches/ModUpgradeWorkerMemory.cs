...
public class ModUpgradeWorkerMemory : ModCustom
{
    ...
    {
        return "WorldObjects/Upgrades/UpgradeWorkerMemoryCrude";
    }
    ...
    public void CreateUpgradeWorkerMemory(string UniqueName, int Level, int Size, string[] NewIngredientsStringArr = null, int[] NewIngredientsAmountArr = null, string ModelName = "", bool UsingCustomModel = true)
    {
        ...
        {
            string descriptionOverride = "Error: ModUpgradeWorkerMemory.CreateUpgradeWorkerMemory '" + UniqueName + "' - Unique Name is null length";
        ...
        {
            string descriptionOverride2 = "Error: ModUpgradeWorkerMemory.CreateUpgradeWorkerMemory '" + UniqueName + "' - Ingredients and Ingredient amounts not equal";
        ...
        if (!GeneralUtils.m_InGame)
        {
            ...
            {
                string descriptionOverride3 = "Error: ModUpgradeWorkerMemory.CreateUpgradeWorkerMemory '" + UniqueName + "' - already used this name!";
            ...
            if (ModelName.Length == 0)
            {
                ModelName = "Models/Upgrades/UpgradeWorkerMemoryCrude";
            }
            ...
            if (DebugInfo)
            {
                Debug.Log("ADDED NEW UPGRADE WORKER MEMORY CALLED " + UniqueName + " (" + UniqueName + ")  ObjID " + objectType);
            }
            ...
            string descriptionOverride4 = "Error: ModUpgradeWorkerMemory.CreateUpgradeWorkerMemory - Cannot find Lua Script";
        ...
        if (!HasSetIngredients[modObjectTypeFromName] && NewIngredientsStringArr != null)
        {
            ...
            for (int i = 0; i < NewIngredientsStringArr.Length; i++)
            {
                ...
                if (!Enum.TryParse<ObjectType>(NewIngredientsStringArr[i], out result))
                {
                    ...
                    {
                        string descriptionOverride5 = "Error: ModUpgradeWorkerMemory.CreateUpgradeWorkerMemory - Object Ingredient '" + NewIngredientsStringArr[i] + "' - cannot be found";
        ...
        VariableManager.Instance.SetVariable(modObjectTypeFromName, "Size", Size);
    }
}
