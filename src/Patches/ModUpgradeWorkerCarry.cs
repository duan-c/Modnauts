...
public class ModUpgradeWorkerCarry : ModCustom
{
    ...
    {
        return "WorldObjects/Upgrades/UpgradeWorkerCarryCrude";
    }
    ...
    public void CreateUpgradeWorkerCarry(string UniqueName, int Level, int Capacity, string[] NewIngredientsStringArr = null, int[] NewIngredientsAmountArr = null, string ModelName = "", bool UsingCustomModel = true)
    {
        ...
        {
            string descriptionOverride = "Error: ModUpgradeWorkerCarry.CreateUpgradeWorkerCarry '" + UniqueName + "' - Unique Name is null length";
        ...
        {
            string descriptionOverride2 = "Error: ModUpgradeWorkerCarry.CreateUpgradeWorkerCarry '" + UniqueName + "' - Ingredients and Ingredient amounts not equal";
        ...
        if (!GeneralUtils.m_InGame)
        {
            ...
            {
                string descriptionOverride3 = "Error: ModUpgradeWorkerCarry.CreateUpgradeWorkerCarry '" + UniqueName + "' - already used this name!";
            ...
            if (ModelName.Length == 0)
            {
                ModelName = "Models/Upgrades/UpgradeWorkerCarryCrude";
            }
            ...
            if (DebugInfo)
            {
                Debug.Log("ADDED NEW UPGRADE WORKER CARRY CALLED " + UniqueName + " (" + UniqueName + ")  ObjID " + objectType);
            }
            ...
            string descriptionOverride4 = "Error: ModUpgradeWorkerCarry.CreateUpgradeWorkerCarry - Cannot find Lua Script";
        ...
        if (!HasSetIngredients[modObjectTypeFromName] && NewIngredientsStringArr != null)
        {
            ...
            for (int i = 0; i < NewIngredientsStringArr.Length; i++)
            {
                ...
                if (!Enum.TryParse<ObjectType>(NewIngredientsStringArr[i], out result))
                {
                    ...
                    {
                        string descriptionOverride5 = "Error: ModUpgradeWorkerCarry.CreateUpgradeWorkerCarry - Object Ingredient '" + NewIngredientsStringArr[i] + "' - cannot be found";
