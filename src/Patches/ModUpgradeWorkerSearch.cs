...
public class ModUpgradeWorkerSearch : ModCustom
{
    ...
    {
        return "WorldObjects/Upgrades/UpgradeWorkerSearchCrude";
    }
    ...
    public void CreateUpgradeWorkerSearch(string UniqueName, int Level, int InitialDelay, int Range, string[] NewIngredientsStringArr = null, int[] NewIngredientsAmountArr = null, string ModelName = "", bool UsingCustomModel = true)
    {
        ...
        {
            string descriptionOverride = "Error: ModUpgradeWorkerSearch.CreateUpgradeWorkerSearch '" + UniqueName + "' - Unique Name is null length";
        ...
        {
            string descriptionOverride2 = "Error: ModUpgradeWorkerSearch.CreateUpgradeWorkerSearch '" + UniqueName + "' - Ingredients and Ingredient amounts not equal";
        ...
        if (!GeneralUtils.m_InGame)
        {
            ...
            {
                string descriptionOverride3 = "Error: ModUpgradeWorkerSearch.CreateUpgradeWorkerSearch '" + UniqueName + "' - already used this name!";
            ...
            if (ModelName.Length == 0)
            {
                ModelName = "Models/Upgrades/UpgradeWorkerSearchCrude";
            }
            ...
            if (DebugInfo)
            {
                Debug.Log("ADDED NEW UPGRADE WORKER SEARCH CALLED " + UniqueName + " (" + UniqueName + ")  ObjID " + objectType);
            }
            ...
            string descriptionOverride4 = "Error: ModUpgradeWorkerSearch.CreateUpgradeWorkerSearch - Cannot find Lua Script";
        ...
        if (!HasSetIngredients[modObjectTypeFromName] && NewIngredientsStringArr != null)
        {
            ...
            for (int i = 0; i < NewIngredientsStringArr.Length; i++)
            {
                ...
                if (!Enum.TryParse<ObjectType>(NewIngredientsStringArr[i], out result))
                {
                    ...
                    {
                        string descriptionOverride5 = "Error: ModUpgradeWorkerSearch.CreateUpgradeWorkerSearch - Object Ingredient '" + NewIngredientsStringArr[i] + "' - cannot be found";
