...
public class ModUpgradeWorkerEnergy : ModCustom
{
    ...
    {
        return "WorldObjects/Upgrades/UpgradeWorkerEnergyCrude";
    }
    ...
    public void CreateUpgradeWorkerEnergy(string UniqueName, int Level, float DriveEnergy, string[] NewIngredientsStringArr = null, int[] NewIngredientsAmountArr = null, string ModelName = "", bool UsingCustomModel = true)
    {
        ...
        {
            string descriptionOverride = "Error: ModUpgradeWorkerEnergy.CreateUpgradeWorkerEnergy '" + UniqueName + "' - Unique Name is null length";
        ...
        {
            string descriptionOverride2 = "Error: ModUpgradeWorkerEnergy.CreateUpgradeWorkerEnergy '" + UniqueName + "' - Ingredients and Ingredient amounts not equal";
        ...
        if (!GeneralUtils.m_InGame)
        {
            ...
            {
                string descriptionOverride3 = "Error: ModUpgradeWorkerEnergy.CreateUpgradeWorkerEnergy '" + UniqueName + "' - already used this name!";
            ...
            if (ModelName.Length == 0)
            {
                ModelName = "Models/Upgrades/UpgradeWorkerEnergyCrude";
            }
            ...
            if (DebugInfo)
            {
                Debug.Log("ADDED NEW UPGRADE WORKER ENERGY CALLED " + UniqueName + " (" + UniqueName + ")  ObjID " + objectType);
            }
            ...
            string descriptionOverride4 = "Error: ModUpgradeWorkerEnergy.CreateUpgradeWorkerEnergy - Cannot find Lua Script";
        ...
        if (!HasSetIngredients[modObjectTypeFromName] && NewIngredientsStringArr != null)
        {
            ...
            for (int i = 0; i < NewIngredientsStringArr.Length; i++)
            {
                ...
                if (!Enum.TryParse<ObjectType>(NewIngredientsStringArr[i], out result))
                {
                    ...
                    {
                        string descriptionOverride5 = "Error: ModUpgradeWorkerEnergy.CreateUpgradeWorkerEnergy - Object Ingredient '" + NewIngredientsStringArr[i] + "' - cannot be found";
        ...
        VariableManager.Instance.SetVariable(modObjectTypeFromName, "DriveEnergy", DriveEnergy);
    }
}
